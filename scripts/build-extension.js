...
const files = {
    // The body is handed to __ddEnhancedBoot rather than run at parse time, so
    // a cold origin can restore settings from chrome.storage before the
    // userscript reads them. On a warm origin it runs synchronously, exactly
    // as it did before.
